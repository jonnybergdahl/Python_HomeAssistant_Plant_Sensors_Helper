...
def main() -> None:
    ...
    print("      <th style=\"text-align: left; padding: 8px; border: 1px solid;\">Status</th>")
    print("    </tr>")
    ...
    print("        <td style=\"padding: 8px; border: 1px solid;\">{{ states(moisture_sensor) }}%</td>")
    print("        <td style=\"padding: 8px; border: 1px solid;\">{{ '✅' if is_state_attr(entity.entity_id, 'moisture_status', 'ok') else '❌' }}</td>")
    print("      </tr>")
    ...
    print("        {% set battery_sensor = 'sensor.' + sensor_name + '_battery' %}")
    print("        <tr>")
    print("          <td style=\"padding: 8px; border: 1px solid;\"><em>↳ Details</em></td>")
    print("          <td style=\"padding: 8px; border: 1px solid;\">Conductivity: {{ states(conductivity_sensor) }} µS/cm</td>")
    print("          <td style=\"padding: 8px; border: 1px solid;\">Battery: {{ states(battery_sensor) }}%</td>")
    print("        </tr>")
    print("      {% endif %}")
    print("    {% endif %}")
    print("  {% endfor %}")
